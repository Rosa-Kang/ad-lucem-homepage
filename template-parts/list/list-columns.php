...
<section class="section-list container content-wrapper">
  <h3 data-aos="fade-right" data-aos-duration="1000" class="italic-subtitle has-text-info-dark is-capitalized">
    <?php echo $list_subheadline ?></h3>
  <h2 data-aos="fade-right" data-aos-duration="2000"><?php echo $list_title ?></h2>
  <div class="columns">
    <?php
    // Check rows exists.
    ...
    ?>
    <div data-aos="fade-left" class="column list-items">
      <?= $list; ?>
    </div>
    <?php
      endwhile;
